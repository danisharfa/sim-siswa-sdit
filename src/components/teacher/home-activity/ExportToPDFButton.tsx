...
export function ExportToPDFButton({ table }: Props) {
  const handleExport = () => {
    ...
    doc.text('LAPORAN AKTIVITAS RUMAH SISWA BIMBINGAN', doc.internal.pageSize.width / 2, 28, {
      align: 'center',
    });
