...
import { HomeActivityTable } from '@/components/teacher/home-activity/HomeActivityTable';

const fetcher = (url: string) => fetch(url).then((res) => res.json());

export function HomeActivityManagement() {
  const { data, error, isLoading, mutate } = useSWR('/api/teacher/home-activity', fetcher);
