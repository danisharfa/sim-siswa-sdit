...
export function MunaqasyahFinalResultTable({ data }: Props) {
  ...
  const currentPeriodInfo = useMemo(() => {
    ...
    return {
      ...
      className: firstResult.classroomName,
      groupName: firstResult.groupName,
    };
  }, [filteredData]);
          ...
          <CardContent className="pt-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
              <div>
                ...
                <div className="font-medium">{currentPeriodInfo.academicYear}</div>
              </div>
              <div>
                <Label className="text-muted-foreground">Semester</Label>
                <div className="font-medium">{currentPeriodInfo.semester}</div>
              </div>
              <div>
                <Label className="text-muted-foreground">Kelas</Label>
                <div className="font-medium">{currentPeriodInfo.className}</div>
              </div>
              <div>
                <Label className="text-muted-foreground">Kelompok</Label>
                <div className="font-medium">{currentPeriodInfo.groupName}</div>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <CardContent className="pt-6">
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg font-semibold">Hasil Final Munaqasyah</h3>
