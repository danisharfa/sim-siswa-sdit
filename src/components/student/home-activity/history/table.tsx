...
import { HomeActivityEditDialog } from './edit-dialog';
import { HomeActivityAlertDialog } from './alert-dialog';
...
export function StudentHomeActivityTable({ data, title, onRefresh }: Props) {
  const {
    sorting,
    setSorting,
    columnFilters,
